...
const CHART_META: Record<string, { title: string; hint: string }> = {
  line: { title: "折线图", hint: "单击或拖拽框选，单击表头选列、单击行首选行，Ctrl+C / Ctrl+V 复制粘贴 · Ctrl+Shift+C 复制引用 · 双击编辑 · 勾选后可批量修改或删除" },
  bar: { title: "柱状图", hint: "单击或拖拽框选，单击表头选列、单击行首选行，Ctrl+C / Ctrl+V 复制粘贴 · Ctrl+Shift+C 复制引用 · 双击编辑 · 勾选后可批量修改或删除" },
  pie: { title: "饼图", hint: "单击或拖拽框选，单击表头选列、单击行首选行，Ctrl+C / Ctrl+V 复制粘贴 · Ctrl+Shift+C 复制引用 · 双击编辑 · 勾选后可批量修改或删除" },
};
