...
const TEMPLATES: EditorTemplate[] = [
  {
    ...
    usage: [
      ...
      "sheet 设 view: table（默认）；按需打开 enableColFilters / enableTableScroll。表格默认只读；单击或拖拽框选，单击表头选列、单击行首选行；Ctrl+C / Ctrl+V 复制粘贴，Ctrl+Shift+C 复制引用；双击单元格编辑；可选择每页行数，默认 100。",
